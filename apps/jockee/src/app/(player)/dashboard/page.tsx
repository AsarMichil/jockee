          ...
          <div>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your latest AI-generated mixes
                </CardDescription>
              </CardHeader>
              <CardContent>
                {recentJobs.length === 0 ? (
                  <p className="text-gray-500">
                    No mixes yet. Analyze a playlist to get started!
                  </p>
                ) : (
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select a playlist to create an AI-powered mix
                </CardDescription>
              </CardHeader>
              <CardContent>
                {playlists.length === 0 ? (
                  <p className="text-gray-500">
                    No playlists found. Make sure you have playlists in your
                    Spotify account.
                  </p>
                ) : (
